...
import cn.edu.sdut.wwzmyapplication.logic.model.getSky
...
class WeatherActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            decorView.systemUiVisibility = View.SYSTEM_UI_FLAG_LAYOUT_STABLE or View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN//表示Activity的布局会显示在状态栏上面
        ...
        weatherSwipeRefresh.setColorSchemeResources(com.google.android.material.R.color.primary_material_dark)
        refreshWeather()
        weatherSwipeRefresh.setOnRefreshListener { refreshWeather() }
